...
Java_id_ac_ui_cs_mobileprogramming_jnimodule_NativeGL_init(JNIEnv *env, jclass clazz, jint w, jint h) {
    setupGL(w, h);
}

extern "C" JNIEXPORT void JNICALL
Java_id_ac_ui_cs_mobileprogramming_jnimodule_NativeGL_update(JNIEnv *env, jclass clazz) {
    renderFrame();
}
...
void renderFrame() {
    ...
    glClearColor(grey, 0.0f, 1.0f, 1.0f);
